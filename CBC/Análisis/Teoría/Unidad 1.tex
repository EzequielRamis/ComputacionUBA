        ...
        \begin{center}
            \begin{scaletikzpicturetowidth}{\linewidth}
                \begin{tikzpicture}[scale=\tikzscale]
                    ...
                    \draw[-open triangle 45] (A.225) -- node[rotate=60,above] {\small{hallar coordenada del vértice}} (B.75);
                    \draw[open triangle 45-] (A.255) -- node[rotate=60,below] {\small{desarrollar cuadrado de binomio}} (B.45);
                    \draw[open triangle 45-] (A.285) -- node[rotate=300,below] {\small{aplicar propiedad distributiva}} (C.135);
