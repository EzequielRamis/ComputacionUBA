  ...
  \item El conductor de un automóvil desea rebasar un camión que viaja a una rapidez constante de \SI{20,0}{\meter\over\second}. Inicialmente, el automóvil también viaja a \SI{20,0}{\meter\over\second} y su paragolpe delantero está \SI{24,0}{\meter} atrás del paragolpes trasero del camión. El automóvil adquiere una aceleración constante de \SI{0,600}{\meter\over\second\squared} y regresa al carril del camión cuando su paragolpe trasero está a \SI{26,0}{\meter} adelante del frente del camión. El automóvil tiene una longitud de \SI{4,50}{\meter}, y el camión tiene una longitud de \SI{21,0}{\meter}.
        ...
        \begin{center}
          \begin{tikzpicture}
            ...
            \draw[red,->] (1,1) to[bend left] node[pos=.5,above]{$a=\SI{0,600}{\meter\over\second\squared}$} (10,1);
          \end{tikzpicture}
        \end{center}
        ...
        \begin{enumerate}
          \item ¿Cuánto tiempo necesita el automóvil para rebasar al camión?
                ...
                \[\SI{4,50}{\meter}+\SI{24,0}{\meter}+\SI{21,0}{\meter}+\SI{26,0}{\meter}=\frac{1}{2}\cdot\SI{0,600}{\meter\over\second\squared}t^2\]
                \[\SI{75,5}{\meter}=\SI{0,300}{\meter\over\second\squared}t^2\]
          ...
          \item ¿Qué distancia recorre el automóvil ese ese tiempo? ¿Qué rapidez final tiene el automóvil?
                ...
                \[x_f=x_i+v_it+\frac{1}{2}at^2\]
                \[x_f=\SI{20,0}{\meter\over\second}\cdot\SI{15,8}{\second}+\frac{1}{2}\cdot\SI{0,600}{\meter\over\second\squared}\cdot(\SI{15,8}{\second})^2\]
                \[x_f=\boxed{\SI{390}{\meter}}\]

                \[v_f=v_i+at\]
                \[v_f=\SI{20,0}{\meter\over\second}+\SI{0,600}{\meter\over\second\squared}\cdot\SI{15,8}{\second}\]
                \[v_f=\boxed{\SI{29,5}{\meter\over\second}}\]
        \end{enumerate}

        \newpage

  \item Se lanza un cohete a escala directamente hacia arriba con una velocidad inicial de \SI{50,0}{\meter\over\second}, y acelera a \SI{2,00}{\meter\over\second\squared} de manera constante hacia arriba hasta que los motores se apagan a una altitud de \SI{150}{\meter}.
        ...
        \begin{multicols}{3}
          ...
          \begin{center}
            \begin{tikzpicture}
              ...
              \fill[red] (0,3) circle(2pt) node[below right]{\SI{50,0}{\meter\over\second}};
            \end{tikzpicture}
          \end{center}
          \begin{center}
            \begin{tikzpicture}
              ...
              \fill[cyan] (0,3) circle(2pt) node[below right]{\SI{2,00}{\meter\over\second\squared}};
              \fill[cyan] (2,1) circle(2pt) node[below right]{\SI{-9,80}{\meter\over\second\squared}};
            \end{tikzpicture}
          \end{center}
        \end{multicols}
