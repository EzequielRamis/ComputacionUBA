...
\begin{enumerate}
  ...
  \item Un objeto experimenta un MAS (movimiento armónico simple) con periodo de \SI{1,200}{\second} y
        ...
        \begin{center}
          ...
          \[ \omega = \frac{2\pi}{\SI{1,200}{\second}} \]
          \[ \omega = \SI{1,667}{\per\second} \]
          \[ \sin0 = 0 \]
          \[ A\sin(\omega t) \]
          \[ (\SI{-0,600}{\meter})\cdot\sin(t\cdot\SI{1,667}{\per\second}) \]
          \[
            (\SI{-0,600}{\meter}) \cdot \sin( \SI{0,480}{\second} \cdot \SI{1,667}{\per\second} )
            = \SI{-0,353}{\meter}
          \]
          \[ \boxed{
