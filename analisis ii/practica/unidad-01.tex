...
\begin{enumerate}
    ...
    \item Calcular $u \x v$ y $\|u \x v\|$
          ...
          \begin{enumerate}
              \item
                    ...
                    \end{tikzpicture}
                    \[ \|u \x v\| = 5*10*\frac{\sqrt{3}}{2} = \boxed{25\sqrt{3}\text{, apunta a} -z} \]
              \item
                    \begin{tikzpicture}[scale = 0.5]
                        \draw[style=vec] (-6,0) -- (0,0)  node[pos=0.5,anchor=south] {$\|u\| = 6$};
                        \draw[style=vec,dashed] (0,0) -- (6,0)  node[pos=0.5,anchor=south] {$\|u\| = 6$};
                    ...
                    \end{tikzpicture}
                    \[ \|u \x v\| = 6 \cdot 8 \cdot \sen(\SI{30}{\degree}) = 48 \cdot \frac{1}{2} = \boxed{24\text{, apunta a} -z} \]
    ...
    \item Calcular el area del paralelogramo de $A = (1, 2, 3)$, $B = (1, 3, 6)$, $C = (3, 8, 6)$, $D = (3, 7 ,3)$ \\
          \begin{tikzpicture}[tdplot_main_coords,grid/.style={very thin,gray},axis/.style={->,blue,thick}]
              ...
              \coordinate (C) at (3, 8, 6);
              \coordinate (D) at (3, 7, 3);
